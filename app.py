...
def cargar_datos():
    ...
    df_grupos = pd.read_excel("grupos_gesparvu_20260413_093134.xlsx", sheet_name="Datos Grupos")
    df_resumen_estab = pd.read_excel("grupos_gesparvu_20260413_093134.xlsx", sheet_name="Resumen por Establecimiento")
